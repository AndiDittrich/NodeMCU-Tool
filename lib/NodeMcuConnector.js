...
/**
 * Uploads multiple local file to NodeMCU
 * @param localFiles a list of local files to upload
 * @param options
 * @param completeCb
 * @param progressCb
 */
NodeMcuConnector.prototype.bulkUpload = function(localFiles, options, completeCb, progressCb){
