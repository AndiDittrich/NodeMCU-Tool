...
async function startTransfer(rawContent, localName, remoteName, progressCb){
    ...
    try{
        ...
        throw new Error('Cannot open remote file "' + remoteName + '" for write - ' + e);
    }
    ...
    async function writeChunk(){
        if (chunks.length > 0){
            ...
            try{
                ...
                throw new Error('Cannot write chunk to remote file - ' + e);
            }
            ...
            try{
                ...
                throw new Error('Cannot flush/close remote file - ' + e);
            }
        }
    }
...
async function requireTransferHelper(){
    ...
    if (_isTransferWriteHelperUploaded !== true){
        ...
        try{
            ...
            throw new Error('Cannot transfer helper function - ' + e);
        }
